...
const webboards = [{
    title: 'แจกวิธีการช่วยเสริมสร้างความจำในการอ่าน',
    description: 'สวัสดีค่ะ วันนี้เราจะมาแนะนำวิธีที่เราใช้ช่วยทำให้เราจดจำเนื้อหาที่อ่านได้เป็นอย่างดีค่ะ ข้อแรกเราจะเน้นข้อความที่สำคัญค่ะ',
    imgProfile: '',
    comments: [{
        name: 'เด็กชายเอ',
        imgProfile: '',
